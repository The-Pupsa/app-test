...
@Component({
  selector: 'app-forecast-chart2',
  templateUrl: './forecast-chart2.component.html',
  styleUrls: ['./forecast-chart2.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ForecastChart2Component implements OnInit, OnDestroy {
